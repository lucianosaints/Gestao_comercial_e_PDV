...
function Vendas() {
    ...
    useEffect(() => {
        ...
        const novoTotal = Math.max(0, subtotal - parseFloat(desconto || 0));
        setTotal(novoTotal);
    }, [carrinho, desconto]);
    ...
    const s = {
        ...
        cartDrawer: {
            ...
            width: isMobile ? '100%' : '400px', maxWidth: '100%',
        ...
        <div style={s.container}>
            ...
            <main style={s.mainContent}>
                <div style={{ marginBottom: '20px', display: 'flex', alignItems: 'center' }}>
                    ...
                    <div>
                        <h1 style={{ margin: 0, color: '#1f2937', fontSize: isMobile ? '22px' : '32px' }}>Frente de Caixa</h1>
                        <p style={{ color: '#6b7280', margin: 0 }}>Selecione os produtos para venda</p>
                    </div>
                </div>
                    ...
                    <div style={{ padding: '20px', borderTop: '1px solid #eee', background: '#fff', overflowY: 'auto', maxHeight: '50vh' }}>
                        <div style={{ marginBottom: '15px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            ...
                            <input
                                ...
                                style={{ width: '100px', padding: '8px', borderRadius: '5px', border: '1px solid #ddd', textAlign: 'right', fontSize: '16px', fontWeight: 'bold', color: '#ef4444' }}
                            />
                        </div>
